...
const Footer = () => (
  <footer>
    <div className="p-4 text-center">
      ...
      <div className="p-2">
        <a className="m-2" href="https://www.facebook.com/Lymstudio.womenfashion" target="_blank" rel="noreferrer">
          <FontAwesomeIcon className="brand-icon" icon={faFacebook} />
        </a>
        <a className="m-2" href="https://www.instagram.com/lymstudios/" target="_blank" rel="noreferrer">
